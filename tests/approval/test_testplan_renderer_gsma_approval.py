...
class TestPlanRendererGsmaApprovalTests(unittest.TestCase):
    """End-to-end approval tests for testplan_renderer_gsma.py CLI."""
...
{result.stderr}"""
    ...
    def _run_cli_result(self, *args):
        """Run testplan_renderer_gsma.py CLI and return stdout, stderr, and return code."""
        cmd = [sys.executable, "testplan_renderer_gsma.py"] + list(args)
...
"""
    ...
    def test_render_with_real_gsma_data(self):
        ...
        self._setup_test_plan_md_placeholder("data/dataset_4_GSMA/container")

        result = self._run_cli_result(
            "--container",
            "data/dataset_4_GSMA/container/schema.json",
            "data/dataset_4_GSMA/container/template.j2",
            "data/dataset_4_GSMA/container/data.yml",
            "--test-case",
            "data/dataset_4_GSMA/test_case/schema.json",
            "data/dataset_4_GSMA/test_case/template.j2",
            "data/dataset_4_GSMA/test_case/gsma_4.4.2.2_TC.yml",
        )
    ...
    def test_render_with_multiple_test_cases(self):
        ...
        result = self._run_cli_result(
            ...
            "data/dataset_4_GSMA/test_case/template.j2",
            "data/dataset_4_GSMA/test_case/gsma_4.4.2.2_TC.yml",
            "data/dataset_4_GSMA/test_case/gsma_4.4.2.3_TC.yml",
        )
