...
def usage(return_code):
    print(
        "Usage: python testplan_renderer.py [-o out] --container container_schema.json container.json --test-case testcase_schema.json test1.yml test2.yml ..."
    )
